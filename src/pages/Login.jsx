    ...
    <div className="min-h-screen bg-[#0a110a] flex items-center justify-center p-4 pt-20">
      <div className="w-full max-w-md bg-[#080d08]/80 backdrop-blur-2xl border border-white/5 rounded-2xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative">
        ...
        <div className="text-center mb-8 relative z-10">
          <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-br from-brand-500 to-brand-800 shadow-[0_0_20px_rgba(124,82,40,0.4)] flex items-center justify-center border border-white/10 mb-4">
            <span className="font-bold text-white text-2xl tracking-widest">{config.nombreDelNegocio.charAt(0).toUpperCase()}</span>
          </div>
          <h2 className="text-2xl font-black text-white uppercase tracking-widest">Acceso Restringido</h2>
          <p className="text-gray-400 text-sm mt-2">Ingresá tus credenciales de administrador</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5 relative z-10">
          <div>
            ...
            <input
              ...
              className="w-full bg-black/40 border border-white/10 rounded-xl p-4 text-white placeholder-gray-600 focus:outline-none focus:border-brand-500/50 focus:ring-1 focus:ring-brand-500/50 transition-all font-medium"
              placeholder="vendedor@app.com"
              required
            />
          </div>
          ...
          <button
            ...
            className={`w-full font-black tracking-widest py-4 rounded-xl transition-all duration-300 mt-2 ${
              cooldown > 0 
                ...
                : 'bg-gradient-to-r from-brand-500 to-brand-700 hover:from-brand-400 hover:to-brand-600 disabled:from-[#1a2c20] disabled:to-[#1a2c20] disabled:text-gray-500 disabled:shadow-none text-white shadow-[0_10px_20px_rgba(124,82,40,0.3)] hover:shadow-[0_10px_30px_rgba(124,82,40,0.5)]'
            }`}
          >

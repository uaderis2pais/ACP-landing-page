...
export function UpdateToast() {
  ...
  return (
    ...
    >
      <div className="bg-[#0c1a10]/95 backdrop-blur-xl border border-brand-500/40 rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.6),0_0_20px_rgba(124,82,40,0.15)] p-4 flex items-center gap-4">
        ...
        <div className="w-10 h-10 rounded-xl bg-brand-500/15 border border-brand-500/30 flex items-center justify-center flex-shrink-0">
          <RefreshCw size={18} className="text-brand-400 animate-spin" style={{ animationDuration: '3s' }} />
        </div>
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            ...
            className="px-3 py-2 bg-gradient-to-r from-brand-500 to-brand-700 text-white text-[10px] font-black uppercase tracking-widest rounded-lg shadow-[0_0_10px_rgba(124,82,40,0.4)] hover:shadow-[0_0_15px_rgba(124,82,40,0.6)] transition-all whitespace-nowrap"
          >
            Actualizar
          </button>
          <button
